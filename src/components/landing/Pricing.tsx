  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex flex-col gap-2">
        <Link
          // The free plan's button is a download now; the paid ones still open
          // the app, because that is where a subscription is started.
          href={plan.price === 0 ? "/download" : "/library"}
          className={cn(
