...
export const SHORTCUTS: ShortcutGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { keys: "⌘C / ⌘X / ⌘V", what: "Copy, cut and paste a whole range" },
      { keys: "⌘D / ⌘R", what: "Fill down, fill right — formulas move with it" },
      { keys: "⌘ + arrows", what: "Jump to the edge of the data" },
      { keys: "Home / End", what: "First, last column of the row" },
      { keys: "⌘Home / ⌘End", what: "First, last cell of the table" },
      { keys: "⇧Space / ⌘Space", what: "Select the row, the column" },
      { keys: "F4", what: "While editing: cycle A1 → $A$1 → A$1 → $A1" },
